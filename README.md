...
> Voice agent for Windows: Whisper STT, an instant regex command path, and a 87-tool agent loop that controls apps, files, settings and PowerShell.
...
<sub>🤖 generated by <code>profile_agent.py</code> · 20 public repos · last run 23 Aug 2026 · 03:15 UTC</sub>
